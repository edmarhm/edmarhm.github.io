      ...
      <div class="collapse navbar-collapse text-center justify-content-center" id="navbar3SupportedContent">
        <ul class="navbar-nav">
          ...
          <li class="nav-item mx-2">
            <a class="nav-link" href="#venue"><b></b></a><b><a href="#">PORTFÓLIO 3D</a></b>
          </li>
          <li class="nav-item mx-2">
            <a class="nav-link" href="#menu"><b></b></a><b><a href="#">LINKEDIN</a><br></b>
          </li>
          <li class="nav-item mx-2">
            <a class="nav-link" href="#menu"><b></b></a><b><a href="#" style="font-weight: normal;"><b>INSTRAGRAM</b></a><br></b>
          </li>
        </ul>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row my-5 bg-secondary animate-in-down">
        <div class="p-4 col-md-6 bg-primary" style="">
          ...
          <img class="d-block img-fluid mx-auto" src="assets/restaurant/signature.png" width="300">
        </div>
        <div class="p-0 col-md-6 bg-primary">
          <img class="img-fluid d-block my-2" src="assets/restaurant/chef_dark.png" style=""> </div>
      </div>
    </div>
  </div>
  <!-- Gallery -->
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="p-0 col-md-2 col-4">
          <img src="assets/colors/1.png" class="img-fluid"> </div>
        <div class="p-0 col-md-2 col-4">
          <img src="assets/colors/2.png" class="img-fluid"> </div>
        <div class="p-0 col-md-2 col-4"><img src="assets/colors/3.png" class="img-fluid"></div>
        <div class="p-0 col-md-2 col-4">
          <img src="assets/colors/4.png" class="img-fluid"> </div>
        <div class="p-0 col-md-2 col-4">
          <img src="assets/colors/5.png" class="img-fluid"> </div>
        <div class="p-0 col-md-2 col-4">
          <img src="assets/colors/6.png" class="img-fluid"> </div>
        <div class="p-0 col-md-2 col-4">
          <img src="assets/colors/13.png" class="img-fluid"><img src="assets/colors/7.png" class="img-fluid"> </div>
        <div class="p-0 col-md-2 col-4">
          <img src="assets/colors/14.png" class="img-fluid"><img src="assets/colors/8.png" class="img-fluid"></div>
        <div class="p-0 col-md-2 col-4">
          <img src="assets/colors/15.png" class="img-fluid"><img src="assets/colors/9.png" class="img-fluid"> </div>
        <div class="p-0 col-md-2 col-4">
          <img src="assets/colors/16.png" class="img-fluid"><img src="assets/colors/10.png" class="img-fluid"> </div>
        <div class="p-0 col-md-2 col-4">
          <img class="img-fluid" src="assets/colors/17.png"><img src="assets/colors/11.png" class="img-fluid"> </div>
        <div class="p-0 col-md-2 col-4">
          <img class="img-fluid" src="assets/colors/18.png"><img class="img-fluid" src="assets/colors/12.png"> </div>
      </div>
    </div>
  </div>
  <!-- Menu -->
    ...
    <div class="container">
      <div class="row my-5 bg-primary animate-in-down">
        <div class="p-4 col-md-6 align-self-center bg-dark text-body" style="">
          ...
          <a href="#" class="btn-outline-light mb-3 p-2 btn text-body">Veja aqui alguns uniformes criados</a>
        </div>
        <div class="col-md-6"><img class="img-fluid d-block rounded mx-auto" src="assets/colors/jump.jpg"></div>
      </div>
    </div>
  </div>
  <!-- Events -->
        ...
        <div class="col-md-12">
          <div class="row">
            <div class="col-md-12 p-3">
              <img class="img-fluid d-block w-100 mb-3" src="../../../../Desktop/mod.png">
            </div>
          </div>
        </div>
      </div>
